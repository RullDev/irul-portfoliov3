...
const technologies = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
        <path d="M11.572 0c-.176 0-.31.001-.358.007a19.76 19.76 0 0 1-.364.033C7.443.346 4.25 2.185 2.228 5.012a11.875 11.875 0 0 0-2.119 5.243c-.096.659-.108.854-.108 1.747s.012 1.089.108 1.748c.652 4.506 3.86 8.292 8.209 9.695.779.25 1.6.422 2.534.525.363.04 1.935.04 2.299 0 1.611-.178 2.977-.577 4.323-1.264.207-.106.247-.134.219-.158-.02-.013-.9-1.193-1.955-2.62l-1.919-2.592-2.404-3.558a338.739 338.739 0 0 0-2.422-3.556c-.009-.002-.018 1.579-.023 3.51-.007 3.38-.01 3.515-.052 3.595a.426.426 0 0 1-.206.214c-.075.037-.14.044-.495.044H7.81l-.108-.068a.438.438 0 0 1-.157-.171l-.049-.106.005-4.703.007-4.705.073-.091a.645.645 0 0 1 .174-.143c.096-.047.134-.052.54-.052.421 0 .558.019.683.098.078.049.155.15.24.313.086.164.475.988 1.085 2.307.143.309 1.031 2.206 1.974 4.217 1.894 4.033 1.822 3.891 2.095 4.159.418.411.944.5 1.463.246.278-.137.518-.489.678-.985.053-.162.098-.32.345-1.215.581-2.098.718-2.585.754-2.698.025-.08.043-.147.048-.147.005 0 .615.786 1.355 1.747 1.635 2.118 2.235 2.883 2.478 3.162.521.599 1.249.876 1.97.743.774-.142 1.296-.657 1.518-1.493.064-.238.172-.907.233-1.435.069-.591.104-1.395.104-2.383 0-1.018-.038-1.847-.313-2.692a11.68 11.68 0 0 0-1.846-3.766C20.678 4.782 17.758 2.89 14.425 2.193a13.164 13.164 0 0 0-2.825-.295A2.768 2.768 0 0 1 11.573 0z"/>
      </svg>
    ),
  },
  {
...
function SpotifyCard() {
  return (
    <div className="bg-white/5 backdrop-blur-lg p-2 rounded-lg shadow-md my-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {technologies.map((tech, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl border border-white/10 hover:border-blue-500/50 transition-colors"
            >
